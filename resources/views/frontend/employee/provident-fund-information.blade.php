    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <center>
                            ...
                            <div>
                                <i class="ni education_hat mr-2"></i>เงินต้นสะสม : {{ $fund }} เงินสมทบ :
                                {{ $percent }} บาท
                            </div>
            ...
            <div class="col-md-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <h5 class="card-header">เงินกองทุนสะสม</h5>
                        <hr class="my-0" />
                        @foreach ($funds as $fund => $value)
                            <div class="row">
                                ...
                                <div class="mb-2 mt-2 col-md-4">
                                    <input class="form-control" type="text"
                                        value="เงินสะสม : {{ number_format((float) $value->fund) }} บาท" />
                                </div>
                                @php
                                ...
                                <div class="mb-2 mt-2 col-md-4">
                                    <input style="color: red;" class="form-control" type="text"
                                        value="ยอดรวมสะสม : {{ number_format((float) $fundTotal) }} บาท" />
                                </div>
                            </div>
                        @endforeach
                    </div>
