...
<div class="container-xxl">
    <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-2" style="text-align:center;">ลงทะเบียนผู้ดูแลระบบ EAKKARNYANG GROUP</h4>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{url('admin/register')}}" method="POST" enctype="multipart/form-data">@csrf
                        ...
                        <div class="mb-3">
                            <button class="btn btn-success d-grid w-100" type="submit" style="font-family: 'Sarabun';">ลงทะเบียนผู้ดูแลระบบ</button>
                        </div>
                    </form>
                </div>
            </div>
