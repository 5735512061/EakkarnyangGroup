...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">จัดการข้อมูลพนักงาน /</span> เพิ่มกลุ่มสาขาในเครือ</h4>
    <div class="row">
      <div class="col-md-12">
        <div class="card mb-4">
          <h5 class="card-header">เพิ่มกลุ่มสาขาในเครือ (EAKKARNYANG GROUP)</h5>
          <div class="card-body">
            <form action="{{url('admin/create-branch-group')}}" method="POST" enctype="multipart/form-data">@csrf
              ...
              <div class="row">
                <div class="mb-3 col-md-6">
                  <label class="form-label">ร้านค้าในเครือ (EAKKARNYANG GROUP)</label>
              ...
              <div class="mt-2">
                <button type="submit" class="btn btn-success me-2" style="font-family: 'Sarabun';">เพิ่มกลุ่มสาขาในเครือ</button>
      ...
      <div class="col-md-12">
        <div class="card">
          <h5 class="card-header">สาขาในเครือ (EAKKARNYANG GROUP)</h5>
                      ...
                      <div class="modal-dialog">
                        <form action="{{url('admin/branch-group-edit')}}" method="POST" enctype="multipart/form-data" class="modal-content">@csrf
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" style="font-family:'Sarabun';">แก้ไขชื่อร้านค้า</button>
                          </div>
                        </form>
                      </div>
                    </div>
