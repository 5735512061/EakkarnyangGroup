                        ...
                        <form action="{{ url('admin/create-position') }}" method="POST" enctype="multipart/form-data">@csrf
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea name="description" id="description-ckeditor" rows="15" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="mt-2">
                                <button type="submit" class="btn btn-success me-2"
                                    style="font-family: 'Sarabun';">เพิ่มตำแหน่งงาน</button>
                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($positions as $position => $value)
                                    <tr>
                                        ...
                                        @php
                                            $brach_group = DB::table('branch_groups')
                                                ->where('id', $value->branch_group_id)
                                                ->value('branch');
                                        @endphp
                                        <td>{{ $brach_group }}</td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ url('/admin/position-delete/') }}/{{ $value->id }}"
                                            ...
                                            <div class="modal fade" id="backDropModal{{ $value->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <form action="{{ url('admin/position-edit') }}" method="POST"
                                                        enctype="multipart/form-data" class="modal-content">@csrf
                                                        <input type="hidden" name="id" value="{{ $value->id }}">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="backDropModalTitle">แก้ไขตำแหน่งงาน
                                                            </h5>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <input type="text" name="position"
                                                                        class="form-control" value="{{ $value->position }}"
                                                                ...
                                                                <div class="mb-3 col-md-12">
                                                                    <label class="form-label">รายละเอียดงาน</label>
                                                                    <textarea name="description" id="description-ckeditor2" rows="15" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-success"
                                                                style="font-family:'Sarabun';">แก้ไขตำแหน่งงาน</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
