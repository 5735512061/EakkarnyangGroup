...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">การประเมินผล /</span> แบบประเมินพนักงาน</h4>
    <div class="row">
      <form action="{{url('admin/create-form-employee-evaluate')}}" method="POST">@csrf
        ...
        <div class="col-md-12">
          <div class="card mb-4">
            <h5 class="card-header">แบบประเมินพนักงาน</h5>
            <div class="card-body">
                <div class="row">
                  ...
                  <td>
                    ...
                    <div class="modal fade" id="backDropModal{{$value->id}}" data-bs-backdrop="static" tabindex="-1">
                      <div class="modal-dialog">
                        <form action="{{url('admin/edit-form-employee-evaluate')}}" method="POST" enctype="multipart/form-data" class="modal-content">@csrf
                          <input type="hidden" name="id" value="{{$value->id}}">
                          <div class="modal-header">
                            <h5 class="modal-title" id="backDropModalTitle">แก้ไขแบบประเมินพนักงาน</h5>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" style="font-family:'Sarabun';">แก้ไขแบบประเมินพนักงาน</button>
                          </div>
                        </form>
                      </div>
                    </div>
