                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <select class="select2 form-select" name="period">
                                        <option value="ช่วงเช้า 08.00-08.45">ช่วงเช้า 08.00-08.45</option>
                                        <option value="ช่วงเย็น 18.30-19.30">ช่วงเย็น 18.30-19.30</option>
                                    </select>
                                </div>
                                <div class="mb-3 col-md-3">
                                                                ...
                                                                <div class="mb-3 col-md-9">
                                                                    ...
                                                                    <select class="select2 form-select" name="period">
                                                                        <option value="{{ $value->period }}">
                                                                            {{ $value->period }}</option>
                                                                        <option value="ช่วงเช้า 08.00-08.45">ช่วงเช้า
                                                                            08.00-08.45</option>
                                                                        <option value="ช่วงเย็น 18.30-19.30">ช่วงเย็น
                                                                            18.30-19.30</option>
                                                                    </select>
                                                                </div>
