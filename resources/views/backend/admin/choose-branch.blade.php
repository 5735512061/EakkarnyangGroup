...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-md-3 col-12 mb-4">
                <a href="{{ url('/admin/manage-benefit') }}">
                    <div class="card">
                        <div class="card-body" style="padding: 1.5rem 1.5rem 0 1.5rem !important;">
                            <div class="่justify-content-between flex-sm-row flex-column gap-3">
                                <div class="flex-sm-column flex-row align-items-start justify-content-between">
            ...
            <div class="col-md-3 col-12 mb-4">
                <a href="{{ url('/admin/best-employee') }}">
                    <div class="card">
                        <div class="card-body" style="padding: 1.5rem 1.5rem 0 1.5rem !important;">
                            <div class="่justify-content-between flex-sm-row flex-column gap-3">
                                <div class="flex-sm-column flex-row align-items-start justify-content-between">
                            ...
                            <div class="่justify-content-between flex-sm-row flex-column gap-3">
                                <div class="flex-sm-column flex-row align-items-start justify-content-between">
                                    <div class="card-title">
                                        ...
                                        <hr>
                                        @php
                                            $amount_employee = DB::table('employees')
                                                ->where('branch_id', $value->id)
                                                ->where('status', 'เปิด')
                                                ->count();
                                        @endphp
                                        <p>จำนวนพนักงานในระบบ {{ $amount_employee }} คน</p>
                                        <a href="{{ url('/admin/dashboard') }}/{{ $value->id }}">
                                            <p style="text-align: right;">จัดการข้อมูลเพิ่มเติม >></p>
                                        </a>
                                    </div>
                                </div>
                            </div>
