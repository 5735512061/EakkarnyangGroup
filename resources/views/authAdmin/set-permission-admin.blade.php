...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">จัดการข้อมูลผู้ดูแล /</span> กำหนดสิทธิ์การใช้งาน</h4>
    <div class="row">
      <div class="col-md-12">
        <a href="{{url('/admin/register')}}" class="btn btn-success mb-2" style="font-family: 'Sarabun';">ลงทะเบียนผู้ดูแลระบบ</a>
        <div class="card">
                      ...
                      <div class="modal-dialog">
                        <form action="{{url('admin/permission-admin-edit')}}" method="POST" enctype="multipart/form-data" class="modal-content">@csrf
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" style="font-family:'Sarabun';">แก้ไขสิทธิ์การใช้งานผู้ดูแลระบบ</button>
                          </div>
                        </form>
                      </div>
                    </div>
