        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{url('admin/create-position')}}" method="POST" enctype="multipart/form-data">@csrf
              ...
              <div class="mt-2">
                <button type="submit" class="btn btn-success me-2" style="font-family: 'Sarabun';">เพิ่มตำแหน่งงาน</button>
                      ...
                      <div class="modal-dialog">
                        <form action="{{url('admin/position-edit')}}" method="POST" enctype="multipart/form-data" class="modal-content">@csrf
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" style="font-family:'Sarabun';">แก้ไขตำแหน่งงาน</button>
                          </div>
                        </form>
                      </div>
                    </div>
