...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-4">
                <a class="btn btn-success mb-4" style="width: 100%; font-family:'Sarabun'; color:#fff;" data-bs-toggle="modal"
                    data-bs-target="#backDropModal" data-bs-toggle="modal" data-bs-target="#backDropModal">
                    แสดงบัตรพนักงาน
                </a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <form action="#" method="POST" enctype="multipart/form-data" class="modal-content">@csrf
                            ...
                            <div class="modal-header"
                                style="margin-top: -30px; background: radial-gradient(ellipse farthest-corner at 0 140%, #4CAF50 0%, #4CAF50 70%, #8BC34A 70%)">
                                <center><img src="{{ url('image/logo_store/eakkarnyang_logo.png') }}" width="40%" />
                                </center>
                            </div>
                            <div class="modal-body">
                                ...
                                <center><img src="{{ url('img_upload/employee-profile') }}/{{ $staff->image }}"
                                        alt="profile" width="50%" /></center><br>
                                <center>
                                    <h5 style="line-height: 0.8; !important">{{ $staff->name }} {{ $staff->surname }}
                                        ({{ $staff->nickname }})</h5>
                                </center>
                                <center>
                                    <h6 style="color: #006a00; line-height: 0.8; !important">ตำแหน่ง : {{ $position }}
                                    </h6>
                                </center>
                                <center>
                                    <h6 style="color: #006a00; line-height: 0.8; !important">{{ $branch }}</h6>
                                </center>
                                <center>
                                    <h6 style="color: rgb(255, 0, 0); line-height: 0.8; !important">{{ $datenow }}</h6>
                                </center>
                            </div>
                            <div class="modal-footer"
                                style="background-color: #389b38; justify-content:center !important; padding: 0.25rem 1.5rem 0.5rem !important;">
                        ...
                        <div class="่justify-content-between flex-sm-row flex-column gap-3">
                            <div class="flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">ข้อมูลการทำงาน</h4>
                                    <hr>
                                    <a href="{{ url('/staff/work-information') }}">
                                        <p style="text-align: right;">ข้อมูลเพิ่มเติม >></p>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body" style="padding: 1.5rem 1.5rem 0 1.5rem !important;">
                        <div class="่justify-content-between flex-sm-row flex-column gap-3">
                            <div class="flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">ข้อมูลใบลางาน</h4>
                                    <hr>
                                    <a href="{{ url('/staff/leave-work') }}">
                                        <p style="text-align: right;">ข้อมูลเพิ่มเติม >></p>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body" style="padding: 1.5rem 1.5rem 0 1.5rem !important;">
                        <div class="่justify-content-between flex-sm-row flex-column gap-3">
                            <div class="flex-sm-column flex-row align-items-start justify-content-between">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">ข้อมูลใบเตือน</h4>
                                    <hr>
                                    <a href="{{ url('/staff/warning') }}">
                                        <p style="text-align: right;">ข้อมูลเพิ่มเติม >></p>
                                    </a>
                                </div>
                            </div>
