    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body">
                    <h4>ยื่นใบลางาน</h4>
                    <button type="button" class="btn btn-success mt-4" data-bs-toggle="modal" data-bs-target="#backDropModal" style="font-family: 'Sarabun';">
                        แบบฟอร์มใบลางาน
                    </button>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog">
                            <form action="{{url('staff/leave-work')}}" method="POST" enctype="multipart/form-data" class="modal-content">@csrf
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" style="font-family: 'Sarabun';">ยื่นใบลางาน</button>
                                </div>
                            </form>
                        </div>
                    </div>
