                    ...
                    <table class="table table-hover">
                        ...
                        @foreach ($managers as $manager => $value)
                            @php
                                ...
                                $manager_rates = DB::table('manager_rates')->where('manager_id',$value->id)
                        ...
                        <tbody class="table-border-bottom-0">
                            <tr>
                                ...
                                @php
                                    $date = DB::table('manager_rates')->where('manager_id',$value->id)->orderBy('created_at','desc')->first();

                                    if($date == NULL) {
                                        $date_mY = NULL;

                                        $rate = DB::table('manager_rates')->where('manager_id',$value->id)
                                        ...
                                        $rateNow = DB::table('manager_rates')->where('manager_id',$value->id)
